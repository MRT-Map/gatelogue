...
cp -Tr "$dir/gatelogue-types-sql" "$dir/gatelogue-types-ts/sql"
rm "$dir/gatelogue-types-ts/sql/copy.sh"
echo "To devs: edit gatelogue-types-sql instead" > "$dir/gatelogue-types-ts/sql/.DO_NOT_EDIT"
