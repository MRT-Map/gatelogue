...
class SharedFacilitySource(Source):
    ...
    def update(self):
        ...
        for company1, station1_name, company2, station2_name in (
            ...
            (rlq, "Central City Warp Rail Terminal", intra, "Central City Warp Rail Terminal"),
            (seat, "Central City Warp Terminal", intra, "Central City Warp Rail Terminal"),
            ...
            (rlq, "Central City Beltway Terminal North", intra, "Central City Beltway Terminal North"),
            ...
            (pac, "Refuge Central", intra, "Refuge Central"),
            (intra, "Skogheim Central", rlq, "Skogheim Central"),
            (intra, "Firewood City Airport", rlq, "Firewood City Airfield"),
            (intra, "Lanatam", rlq, "Lanatam"),
            (intra, "Mojang Town Transit Hub", rlq, "Mojang Town Transit Hub"),
            (nflr, "Mojang Town Transit Hub", rlq, "Mojang Town Transit Hub"),
            (nflr, "Weston Main", intra, "Weston Main Station"),
            (blu, "Bristol Downtown", intra, "Bristol Downtown"),
        ):
