...
class SharedFacilityContext(BaseContext, Source):
    ...
    def update(self):
        ...
        for company1, station1_name, company2, station2_name in (
            ...
            (intra, "Liveray", nflr, "Foresne Liveray"),
            ...
            (intra, "MCR HQ", intra, "Scarborough MCR HQ"),
            ...
            (fr, "UCWTIA", intra, "Formosa-Sealane-Danielston UCWT International Airport West"),
            ...
            (blu, "New Acreadium - Schiphol International", intra, "New Acreadium Schiphol Airport"),
            ...
            (nflr, "WMI / Blackwater", intra, "Deadbush Blackwater"),
            ...
            if station1 is None or station2 is None:
                rich.print(
                    ERROR
                    + f"Either {company1} {station1_name} ({station1}) or {company2} {station2_name} ({station2}) does not exist"
                )
                continue
